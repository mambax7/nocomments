...
'
    ...
    define(
        '_NOCOMMENTS_BEGIN7',
        '<ul><li>Open the file xoop_version.php of <strong>this module</strong> and copy the commented code to <strong>your module\'s</strong> xoops_version.php</li>
