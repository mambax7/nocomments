...
'
    ...
    define(
        '_NOCOMMENTS_BEGIN7',
        '<ul><li>Ouvez le fichier xoop_version.php de <strong>ce module</strong> et copiez les lignes commentées dans  le xoops_version.php de <strong>votre module</strong>.</li>
