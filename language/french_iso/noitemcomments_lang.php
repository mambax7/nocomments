...
define('_MI_NOITEMCOMMENTS_BY', 'R�dig� par ');
define('_MI_NOITEMCOMMENTS_DATEPOSTED', 'Post�');
define('_MI_NOITEMCOMMENTS_MODERATED', 'Edit�');
define('_MI_NOITEMCOMMENTS_MEMBERSINCE', 'Utilisateur depuis');
define('_MI_NOITEMCOMMENTS_LOCATION', 'R�sidence');
...
define('_CM_DOSMILEY', 'Activer les �motic�nes');
...
define('_CM_REPLIES', 'R�ponse(s)');
define('_CM_PARENT', 'Parent');
define('_CM_TOP', 'Top');
define('_CM_BOTTOM', 'Bas');
define('_CM_ONLINE', 'En ligne !');
define('_CM_POSTED', 'Post�'); // Posted date
define('_CM_UPDATED', 'Mis � jour');
define('_CM_THREAD', 'Sujet');
define('_CM_POSTER', 'Auteur');
define('_CM_JOINED', 'Inscrit');
define('_CM_POSTS', 'Contribution');
define('_CM_FROM', 'De');
define('_CM_COMDELETED', 'Commentaire(s) effac�(s).');
define('_CM_COMDELETENG', 'Le commentaire ne peut �tre effac�.');
define('_CM_DELETESELECT', 'Effacer tous les commentaires li�s ?');
...
define('_CM_COMAPPROVEADMIN', 'Tous les commentaires doivent �tre approuv�s par l\'administrateur');
define('_CM_COMANONPOST', 'Autoriser les anonymes � r�diger des commentaires ?');
define('_CM_COMNOCOM', 'Commentaires d�sactiv�s');
